...
SELECT
    ...
    now()
FROM
    "PDM-SpectrumEmery"."Attribute_Values" av
        INNER JOIN "PDM-SpectrumEmery"."Attribute_Values" av_address_1
                   ON av."Object_Id" = av_address_1."Object_Id"
                       AND av_address_1."Attribute_Id" = 'SYS_ATTR300'
        INNER JOIN "PDM-SpectrumEmery"."Attribute_Values" av_address_2
                   ON av."Object_Id" = av_address_2."Object_Id"
                       AND av_address_2."Attribute_Id" = 'SYS_ATTR301'
        INNER JOIN "PDM-SpectrumEmery"."Attribute_Values" av_city
                   ON av."Object_Id" = av_city."Object_Id"
                       AND av_city."Attribute_Id" = 'SYS_ATTR302'
        INNER JOIN "PDM-SpectrumEmery"."Attribute_Values" av_state
                   ON av."Object_Id" = av_state."Object_Id"
                       AND av_state."Attribute_Id" = 'SYS_ATTR303'
        INNER JOIN "PDM-SpectrumEmery"."Attribute_Values" av_postal_code
