...
SELECT
    ...
    now()
FROM
    "PDM-LifePoint"."Attribute_Values" av
INNER JOIN "PDM-LifePoint"."Attribute_Values" av_address
...
INNER JOIN "PDM-LifePoint"."Attribute_Values" av_city
        ON av."Object_Id" = av_city."Object_Id"
       AND av_city."Attribute_Id" = 'SYS_ATTR302'
INNER JOIN "PDM-LifePoint"."Attribute_Values" av_state
        ON av."Object_Id" = av_state."Object_Id"
       AND av_state."Attribute_Id" = 'SYS_ATTR303'
INNER JOIN "PDM-LifePoint"."Attribute_Values" av_postal_code
